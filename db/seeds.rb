...
product7 = Product.create(name: "Nike", price: 4800, image_url: "https://i.pinimg.com/564x/30/04/11/3004112b01baaaf940620d1df7c7c745.jpg", description: "Black and rose red Nike airs force 1s mid top without the strap they look absolutely beautiful. ", released_year: 2019, category_id:category1.id, user_id: user1.id )
...
product13 = Product.create(name: "Ciness", price: 7800, image_url: "https://i.pinimg.com/564x/7a/e4/89/7ae4896f74eeff7ae8089b4c23be4c53.jpg", description: "Brand Name: CINESSDUpper Material: flockOrigin: CN(Origin)Heel ", released_year: 2019, category_id:category1.id, user_id: user1.id )
product14 = Product.create(name: "Darling", price: 5800, image_url: "https://i.pinimg.com/564x/a6/a5/cc/a6a5cc69f92b05a0acf9d17e47e6f3ea.jpg", description: "Black and rose red Nike airs force 1s mid top without the strap they look absolutely beautiful. ", released_year: 2019, category_id:category1.id, user_id: user1.id )
product15 = Product.create(name: "Air Mesh", price: 6100, image_url: "https://i.pinimg.com/564x/0a/85/62/0a856259f1c834d489a6761fb56ff7b4.jpg", description: "SPECIFICATIONSUpper Material: Mesh (Air mesh)Season", released_year: 2019, category_id:category1.id, user_id: user1.id )
product16 = Product.create(name: "Microfiber", price: 7700, image_url: "https://i.pinimg.com/564x/15/40/f9/1540f93dc084f85482fbee9cb976a535.jpg", description: "Black and rose red Nike airs force 1s mid top without the strap they look absolutely beautiful. ", released_year: 2019, category_id:category1.id, user_id: user1.id )
...
product18 = Product.create(name: "Boss", price: 4800, image_url: "https://i.pinimg.com/564x/fc/8e/60/fc8e6098f053cdeadb6dc4db334112eb.jpg", description: "During summer, picking the right footwear becomes extremely importan ", released_year: 2019, category_id:category1.id, user_id: user1.id )
product19 = Product.create(name: "Breathable Doug", price: 2900, image_url: "https://i.pinimg.com/564x/79/f3/22/79f322e875abb88ac9c4a2bcc40cfab2.jpg", description: "pring breathable doug men loafers casual shoes increased within flats the British fashion lace up male", released_year: 2017, category_id:category1.id, user_id: user1.id )
product20 = Product.create(name: "Puma", price: 7300, image_url: "https://i.pinimg.com/564x/7a/9c/38/7a9c38b7ed87b0e83c72534692d0c578.jpg", description: "Black and rose red Nike airs force 1s mid top without the strap they look absolutely beautiful. ", released_year: 2019, category_id:category1.id, user_id: user1.id )
